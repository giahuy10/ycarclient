...
$html ="";
$html .='
<h2>Báo cáo Ycar.vn tháng '.$date_report.'</h2>
...
foreach ($bookings as $booking) {
	...
	$html .='<tr><td colspan="3"> Tổng </td><td>'.number_format($total).'</td><td>'.number_format($total_sale).'</td><td>'.number_format($total_driver).'</td><td>'.number_format($total_ycar).'</td></tr>';
$html.='</table>';
echo $html;
...
$mailer->setSubject('Báo cáo Ycar tháng '.$date_report);
$mailer->isHtml(true);
